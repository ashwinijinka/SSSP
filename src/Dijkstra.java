...
public class Dijkstra {
	...
	public static void findSSSP(Graph g){
...
*/		
			...
			for (int i=1; i<n; i++) {
				...
				System.out.println("Distance to vertex "+	g.getVertices().get(i)+" is "+answers[i].distance+". ");
			
		
				// Set up variables to reconstruct the desired path.
				String path = "";
				int end=g.getVertices().get(i);
				//int end = i;
				int source =g.getVertices().get(0);
				//int source=0;
